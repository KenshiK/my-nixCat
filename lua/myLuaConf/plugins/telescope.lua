...
return {
  {
    ...
    {'<leader>/', function()
      ...
      { "<leader>st", function() return require('telescope.builtin').live_grep() end, mode = {"n"}, desc = '[S]earch [T]ext by grep', },
      { "<leader>sw", function() return require('telescope.builtin').grep_string() end, mode = {"n"}, desc = '[S]earch current [W]ord', },
      { "<leader>sb", function() return require('telescope.builtin').builtin() end, mode = {"n"}, desc = '[S]earch Telescope [B]uiltin', },
