...
require('lze').load {
  ...
  },
  {
    ...
    keys = { 
      ...
      { "<leader>u", "<cmd>Telescope undo<CR>", mode = { "n" }, desc = "Open Undo Tree" },
    },
    before = function(_)
  ...
  },
  {
    ...
    after = function(plugin)
      require('mini.ai').setup({
        -- Trouver pourquoi il aime pas mes custom textobjects ou si j'en ai encore besoin. (vérifer les maj)
          -- custom_textobjects = {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>0", function() require("harpoon"):list():select(10) end, desc = "harpoon to file 10", },
    },
    after = function(plugin)
    ...
    after = function (plugin)
      ...
      require('lualine').setup({
        ...
        sections = {
            ...
            lualine_b = { {'filetype', icon = { align = 'left' }}, 'lsp_status', 'lsp_progress'  },
            lualine_c = { {'filename', path = 1}, 'diagnostics' },
            lualine_x = { },
            lualine_y = { 'diff', 'branch', 'fileformat', 'encoding' },
            lualine_z = { {'location', separator = { right = '' }, left_padding = 2 } }
        },
        extensions = { 'nvim-dap-ui', 'fzf' }
        -- options = {
        --   icons_enabled = false,
    ...
    after = function (plugin)
      require('gitsigns').setup({
        ...
        on_attach = function(bufnr)
          ...
          map('n', '<leader>hR', gs.reset_buffer, { desc = 'git Reset buffer (whole file)' })
